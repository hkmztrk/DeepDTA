...
def argparser():
    ...
    parser.add_argument(
        "--num_hidden", type=int, default=0, help="Number of neurons in hidden layer."
    )
    parser.add_argument(
        "--num_classes", type=int, default=0, help="Number of classes (families)."
    )
    parser.add_argument(
        "--max_seq_len", type=int, default=0, help="Length of input sequences."
    )
    parser.add_argument(
        "--max_smi_len", type=int, default=0, help="Length of input sequences."
    )
    # for learning
    parser.add_argument(
    ...
    parser.add_argument(
        "--is_log", type=int, default=0, help="use log transformation for Y"
    )
    parser.add_argument(
        "--checkpoint_path", type=str, default="", help="Path to write checkpoint file."
    )
    parser.add_argument(
        "--log_dir", type=str, default="/tmp", help="Directory for log data."
    )
